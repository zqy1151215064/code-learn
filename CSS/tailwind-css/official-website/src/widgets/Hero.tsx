	...
	return (
		<div className="grid justify-items-center gap-8 pb-28 relative">
			...
			<p className="text-xl text-gray-700 md:w-1/2 text-center">
				这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具这是一个完美的工具
			</p>
			<div>
			...
			<div className="relative grid justify-items-center">
				<video src={Video} className="w-[768px] h-[432px] object-cover object-top rounded"></video>
